...
const fallbackCategoryMap = {
  sports: {
    ...
    list: [
      { id: 's1', detailId: 'sports-baduanjin', title: '八段锦', desc: '八段锦作为国家级非物质文化遗产，动作柔和连绵，滑利流畅，不仅能强身健体，还能调节内脏功能。', cover: '/images/baduanjin.png', tag: '热门功法' },
      { id: 's2', detailId: 'sports-wuqinxi', title: '五禽戏', desc: '神医华佗创编的导引养生功法，模仿虎、鹿、熊、猿、鸟五种动物的形态和神态。', cover: '/images/wuqinxi.png', tag: '导引养生' },
      { id: 's3', detailId: 'sports-taiji', title: '太极拳', desc: '结合易经阴阳五行之变化，中医经络学说，是一种内外兼修、柔和、缓慢、轻灵的拳术。', cover: '/images/taiji.png', tag: '内外兼修' }
    ]
  },
  food: {
    title: '传统饮食 (食)',
    ...
    list: [
      { id: 'f1', detailId: 'food-soup', title: '百合雪梨汤', desc: '结合《本草纲目》的记载，百合与雪梨的搭配不仅是传统的美味，更是秋季润肺降燥的佳品。', cover: '/images/soup.png', tag: '秋季食疗' },
      { id: 'f2', detailId: 'food-tea', title: '非遗茶文化', desc: '茶，发乎神农，闻于鲁周公。饮茶不仅是解渴，更是修身养性、清心雅志的健康生活方式。', cover: '/images/tea.png', tag: '修身养性' }
    ]
  },
  medicine: {
    title: '传统医药 (医)',
    ...
    list: [
      { id: 'm1', detailId: 'medicine-acupuncture', title: '中医针灸', desc: '被列入人类非物质文化遗产代表作名录的针灸，通过刺激人体特定穴位来疏通经络、调和气血。', cover: '/images/acupuncture.png', tag: '疏通经络' },
      { id: 'm2', detailId: 'medicine-tuina', title: '中医推拿', desc: '以人疗人，运用推、拿、提、捏、揉等手法，在人体经络穴位上进行治疗和保健。', cover: '/images/tuina.png', tag: '物理理疗' }
    ]
  },
  music: {
    title: '传统音乐 (乐)',
    ...
    list: [
      { id: 'mu1', detailId: 'music-guqin', title: '古琴疗愈', desc: '古琴音色深沉、余音悠远，听之可平复情绪，适合现代人冥想放松与精神疗愈。', cover: '/images/guqin.png', tag: '静心安神' }
    ]
  }
};
